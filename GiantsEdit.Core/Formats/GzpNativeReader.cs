...
/// and uses LZ77 compression (same as GBS files).
/// </summary>
public static class GzpNativeReader
{
    ...
    /// </summary>
    public static Dictionary<string, GzpEntry> BuildIndex(string gzpPath)
    {
        var entries = new Dictionary<string, GzpEntry>(StringComparer.OrdinalIgnoreCase);
    ...
    /// </summary>
    public static byte[] ExtractEntry(GzpEntry entry)
    {
    ...
    /// </summary>
    public static Dictionary<string, GzpEntry> BuildIndexFromDirectory(string binPath)
    {
        var combined = new Dictionary<string, GzpEntry>(StringComparer.OrdinalIgnoreCase);
